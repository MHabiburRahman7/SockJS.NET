...
using syp.biz.SockJS.NET.Framework.Common.Extensions;
using syp.biz.SockJS.NET.Framework.Common.Interfaces;

namespace syp.biz.SockJS.NET.Framework.Client.Implementations.Transports
{
    ...
    internal class SystemWebSocketTransport : ITransport
    {
        ...
        public async Task Send(string data, CancellationToken token)
        {
            ...
            await this._socket.SendAsync(sendBuffer, WebSocketMessageType.Text, true, token);
        }
            ...
            try
            {
                ...
                while (!this._cts.IsCancellationRequested && this._socket.State == WebSocketState.Open)
                {
                    ...
                    do
                    {
                        ...
                        var clean = data.Replace("\0", string.Empty);
        ...
        private void Configure(ClientWebSocketOptions options, ITransportConfiguration config)
        {
            ...
            //This attribute is not exist in net framework
